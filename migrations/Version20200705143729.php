 ...
 */
final class Version20200705143729 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song CHANGE category_id category_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE song CHANGE category_id category_id INT NOT NULL');
    }
}
